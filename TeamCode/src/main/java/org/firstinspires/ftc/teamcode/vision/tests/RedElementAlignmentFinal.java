...
public class RedElementAlignmentFinal extends OpenCvPipeline {
    ...
    public RedElementAlignmentFinal() {
        // Set the color range for detecting the red element
        low = new Scalar(0, 185.6, 0, 0);
        high = new Scalar(255, 255, 117.6, 255); // Adjusted upper bound for red
    }

    public RedElementAlignmentFinal(Scalar lowerBound, Scalar upperBound) {
        low = lowerBound;
        high = upperBound;
    }
    ...
    public Mat processFrame(Mat input) {
        ...
        Imgproc.putText(input, "Red", new Point(135, 10), Imgproc.FONT_HERSHEY_SIMPLEX, 0.4, new Scalar(255, 0, 0), 1);
