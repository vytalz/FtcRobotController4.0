...
public class YellowElementDetector extends OpenCvPipeline {
    ...
    public YellowElementDetector() {
        // Set the color range for red
        low = new Scalar(0, 0, 0, 0);
        high = new Scalar(255, 255, 92.1, 255); // Adjusted upper bound for red
    }

    public YellowElementDetector(Scalar lowerBound, Scalar upperBound) {
        low = lowerBound;
        high = upperBound;
    }
