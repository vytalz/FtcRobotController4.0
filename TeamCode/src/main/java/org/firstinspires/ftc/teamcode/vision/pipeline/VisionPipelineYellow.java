...
public class VisionPipelineYellow {

    private OpenCvCamera camera;
    private final String cameraName;
    private YellowElementAlignmentFinal capstonePipeline;
    private final HardwareMap hardwareMap;
    private final int width, height;

    // Constructors for the pipeline
    public VisionPipelineYellow(HardwareMap hMap, String camName) {
        hardwareMap = hMap;
        cameraName = camName;
        width = 432;
        height = 240;
    ...
    public VisionPipelineYellow(HardwareMap hMap, String camName, int width, int height) {
        hardwareMap = hMap;
        cameraName = camName;
        this.width = width;
        this.height = height;
    ...
    public void init() {
        ...
        capstonePipeline = new YellowElementAlignmentFinal();  // Initialize the yellow element detection pipeline
